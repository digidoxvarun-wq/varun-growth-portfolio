(() => {
  ...
  function removeRecommendationSection() { document.querySelector(".recommendation-section")?.remove(); }
  ...
  function transformPositioningSection() {
    ...
    section.innerHTML = `<div class="container"><div class="positioning-head"><p class="eyebrow">POSITIONING TRANSFORMATION</p><h2>From Service Provider<br>To Revenue Growth Partner</h2><p>The website now connects proven performance marketing experience with current services across Google Ads, Shopify development, AI automation, WhatsApp and email marketing.</p></div><div class="transformation-stage" aria-label="Before and after positioning transformation"><div class="transform-panel before-panel"><h3>Before</h3><p class="panel-note">Separate services without one revenue journey.</p><div class="fragment-grid"><article class="fragment-card reveal-item"><strong>One-Off Ads</strong><span>Campaign activity without a full conversion path.</span></article><article class="fragment-card reveal-item"><strong>Manual Follow-Ups</strong><span>Leads handled slowly across disconnected tools.</span></article><article class="fragment-card reveal-item"><strong>Store Fixes</strong><span>Website changes without conversion measurement.</span></article><article class="fragment-card reveal-item"><strong>Basic Campaigns</strong><span>Marketing sent without segmentation or automation.</span></article><article class="fragment-card reveal-item"><strong>Scattered Reports</strong><span>Data exists, but decisions take longer.</span></article><article class="fragment-card reveal-item"><strong>Service Tasks</strong><span>Execution feels separate from business growth.</span></article></div><p class="fragment-caption reveal-item">Disconnected execution layer</p></div><div class="bridge reveal-item" aria-label="Positioning upgrade bridge"><div class="bridge-beam" aria-hidden="true"></div><div class="bridge-core"><div class="bridge-copy"><span>Positioning Upgrade</span><strong>+<span data-upgrade-counter>0</span>%</strong><small>service provider -&gt; revenue partner</small></div></div></div><div class="transform-panel after-panel"><h3>After</h3><p class="panel-note">One journey from traffic to conversion, automation and retention.</p><div class="after-ecosystem" aria-label="Connected revenue growth modules"><svg class="ecosystem-lines" viewBox="0 0 520 430" preserveAspectRatio="none" aria-hidden="true"><path d="M94 68 C188 112 214 150 260 215"></path><path d="M426 68 C332 112 306 150 260 215"></path><path d="M94 210 C176 214 212 214 260 215"></path><path d="M426 210 C344 214 308 214 260 215"></path><path d="M130 372 C205 314 228 260 260 215"></path><path d="M390 372 C315 314 292 260 260 215"></path></svg><article class="module-card m1 reveal-item"><strong>Google Ads</strong><span>High-intent traffic and lead generation.</span></article><article class="module-card m2 reveal-item"><strong>Shopify Websites</strong><span>Stores and pages built for conversion.</span></article><article class="module-card m3 reveal-item"><strong>AI Automation</strong><span>Workflows that reduce manual operations.</span></article><article class="module-card core reveal-item"><strong>Revenue Growth Partner</strong><span>The connected layer across traffic, sales and retention.</span></article><article class="module-card m4 reveal-item"><strong>WhatsApp Marketing</strong><span>Fast conversations and customer follow-up.</span></article><article class="module-card m5 reveal-item"><strong>Email Marketing</strong><span>Nurture, retention and repeat purchase flows.</span></article><article class="module-card m6 reveal-item"><strong>Tracking &amp; Reporting</strong><span>Clear decisions from conversion data.</span></article></div></div></div><div class="outcome-badges" aria-label="Transformation outcomes"><div class="outcome-badge reveal-item">Lead Generation <span>&uarr; Stronger</span></div><div class="outcome-badge reveal-item">Conversion Path <span>&uarr; Clearer</span></div><div class="outcome-badge reveal-item">Automation Value <span>&uarr; Higher</span></div><div class="outcome-badge reveal-item">Retention Focus <span>&uarr; Better</span></div><div class="outcome-badge reveal-item">Service Clarity <span>&uarr; Improved</span></div></div></div>`;
  }
  ...
  function transformGrowthStackSection() {
    ...
    section.innerHTML = `<div class="container"><div class="growth-stack-head stack-reveal"><div><p class="eyebrow">GROWTH TECHNOLOGY STACK</p><h2>The Stack Behind Traffic, Conversion And Automation</h2></div><p>A complete acquisition, conversion and automation stack built around Google Ads, Shopify websites, WhatsApp, email, AI workflows and reporting.</p></div><div class="stack-stage" aria-label="Growth technology ecosystem"><div class="stack-side stack-left"><article class="stack-layer ads stack-reveal" data-stack-layer><div class="layer-top"><h3>Acquisition Layer</h3><span></span></div><div class="tool-grid">${tool("Google Ads","High-intent traffic","Generates leads from active demand.")}${tool("Google Analytics","Behavior insights","Shows which visitors convert.")}${tool("Google Tag Manager","Tracking control","Keeps conversion signals clean.")}${tool("Looker Studio","Reporting","Turns campaign data into decisions.")}</div></article><article class="stack-layer web stack-reveal" data-stack-layer><div class="layer-top"><h3>Website &amp; Conversion Layer</h3><span></span></div><div class="tool-grid">${tool("Shopify","Store development","Builds conversion-ready ecommerce experiences.")}${tool("WordPress","Business websites","Creates flexible service and lead pages.")}${tool("Landing Pages","Offer clarity","Matches page message to traffic intent.")}${tool("Conversion Tracking","Measurement","Connects actions to business outcomes.")}</div></article></div><div class="stack-core stack-reveal"><div><strong>Revenue<br>Growth<br>Stack</strong><span>Traffic To Retention</span></div></div><div class="stack-side stack-right"><article class="stack-layer crm stack-reveal" data-stack-layer><div class="layer-top"><h3>Automation &amp; Communication Layer</h3><span></span></div><div class="tool-grid">${tool("WhatsApp Business","Lead response","Moves enquiries into faster conversations.")}${tool("Email Platforms","Retention","Nurtures customers and repeat buyers.")}${tool("n8n","Workflow automation","Connects tools without manual work.")}${tool("AI Tools","Execution support","Speeds up repeatable business processes.")}${tool("OpenAI / Claude","AI assistance","Supports content, logic and workflow thinking.")}</div></article><article class="stack-layer analytics stack-reveal" data-stack-layer><div class="layer-top"><h3>Operations &amp; Reporting Layer</h3><span></span></div><div class="tool-grid">${tool("Automation Platforms","Process systems","Routes leads, tasks and updates.")}${tool("Google Sheets","Lightweight database","Organizes leads and operations.")}${tool("Dashboards","Decision layer","Shows progress across traffic and sales.")}${tool("Attribution","Channel clarity","Connects growth actions to outcomes.")}</div></article></div></div><div class="expertise-row stack-reveal" aria-label="Verified expertise badges"><div class="expertise-badge"><i></i>Google Ads</div><div class="expertise-badge"><i></i>Google Analytics</div><div class="expertise-badge"><i></i>Shopify</div><div class="expertise-badge"><i></i>AI Automation</div><div class="expertise-badge"><i></i>WhatsApp &amp; Email</div></div><div class="growth-process stack-reveal"><h3>Process Framework</h3><div class="process-rail" aria-label="Growth operating process"><div class="process-step-mini"><i>01</i><span>Audit</span></div><div class="process-step-mini"><i>02</i><span>Strategy</span></div><div class="process-step-mini"><i>03</i><span>Tracking</span></div><div class="process-step-mini"><i>04</i><span>Build</span></div><div class="process-step-mini"><i>05</i><span>Launch</span></div><div class="process-step-mini"><i>06</i><span>Automate</span></div><div class="process-step-mini"><i>07</i><span>Report</span></div><div class="process-step-mini"><i>08</i><span>Scale</span></div></div></div></div>`;
  }
  ...
  function updateList(items, values) {
    items.forEach((item, index) => { if (values[index] !== undefined) item.textContent = values[index]; });
  }

  function updateBelowHeroCopy() {
    updateHtml("#ai-engine .section-heading h2", "How the <span class=\"gradient-text\">growth engine</span> connects traffic, conversion and automation.");
    updateText("#ai-engine .section-heading p:not(.eyebrow)", "Google Ads captures intent, Shopify converts visitors, WhatsApp and email nurture leads, and AI automation removes manual work.");
    updateList([...document.querySelectorAll("#ai-engine .node-input span")], ["GOOGLE ADS", "SHOPIFY", "WHATSAPP", "EMAIL"]);
    updateList([...document.querySelectorAll("#ai-engine .node-output span")], ["LEADS", "CONVERT", "FOLLOW UP", "AUTOMATE"]);
    updateText("#ai-engine .chip-1", "Intent Leads");
    updateText("#ai-engine .chip-2", "Store CVR");
    updateText("#ai-engine .chip-3", "Manual Work -");
    replaceEngineTerminal();

    updateText("#about .section-heading h2", "Google Ads, Shopify websites, AI automation and retention marketing working as one growth path.");
    updateText("#about .section-heading p", "I help businesses generate more leads, improve conversions and automate customer communication through Google Ads, Shopify websites, AI automation systems and WhatsApp plus email marketing.");
    const aboutParagraphs = document.querySelectorAll("#about .about-card p");
    if (aboutParagraphs[0]) aboutParagraphs[0].textContent = "My past performance marketing and Meta Ads budget experience gives me a strong foundation in acquisition economics. Today, I use that experience to help local businesses, ecommerce stores, consultants, coaches and startups grow through Google Ads, Shopify development and automation.";
    if (aboutParagraphs[1]) aboutParagraphs[1].textContent = "The goal is practical: bring more qualified traffic, convert it through better pages, follow up faster with WhatsApp and email, and remove manual work with AI automation systems.";
    updateList([...document.querySelectorAll("#about .about-tags span")], ["Google Ads", "Shopify Development", "AI Automation", "WhatsApp Marketing", "Email Marketing", "Conversion Tracking"]);

    updateText("#how-we-work .how-work-head h2", "From Business Goal To Live Growth System");
    updateText("#how-we-work .how-work-head p:not(.eyebrow)", "Every engagement starts with the business goal, then connects traffic, website conversion, automation, follow-up and reporting into one clear execution path.");
    const processTitles = ["Business Audit & Goal Mapping", "Strategy & System Planning", "Build, Launch & Automate", "Optimize & Scale"];
    const processDescriptions = ["Map the offer, audience, website, tracking and current lead flow.", "Plan Google Ads, Shopify pages, automation logic and follow-up journeys.", "Launch campaigns, pages, tracking, WhatsApp, email and AI workflows.", "Review performance, improve conversion paths and scale what works."];
    document.querySelectorAll("#how-we-work .process-step-card h3").forEach((title, index) => { title.textContent = processTitles[index] || title.textContent; });
    document.querySelectorAll("#how-we-work .process-step-card p").forEach((text, index) => { text.textContent = processDescriptions[index] || text.textContent; });

    updateText("#services .service-packages-head h2", "Services Built Around Leads, Websites, Automation And Retention");
    updateText("#services .service-packages-head p", "Choose the service that solves your biggest traffic, conversion or follow-up bottleneck.");
    const packages = [
      { icon: "G", tag: "Lead Generation", title: "GOOGLE ADS MANAGEMENT", price: "₹8,000", suffix: "/ month", bullets: ["Campaign Setup", "Keyword Research", "Conversion Tracking", "Weekly Optimization", "Performance Reporting"], outcome: "Generate High-Intent Leads", cta: "Start Google Ads" },
      { icon: "S", tag: "Google + Shopify", title: "GOOGLE ADS + SHOPIFY GROWTH PACKAGE", price: "₹20,000", suffix: "/ project", bullets: ["Google Ads Management", "Shopify Store Setup", "Landing Page Optimization", "Conversion Tracking", "Speed Optimization + Growth Reporting"], outcome: "Acquire More Customers And Improve Conversion Rates", cta: "Build My Growth System" },
      { icon: "A", tag: "Operational Efficiency", title: "AI AUTOMATION SETUP", price: "₹5,000", suffix: "/ setup", bullets: ["Lead Routing", "Workflow Automation", "WhatsApp Integrations", "CRM Integrations", "Task Automation"], outcome: "Reduce Manual Work And Improve Efficiency", cta: "Automate My Business" },
      { icon: "W", tag: "Retention Marketing", title: "WHATSAPP & EMAIL MARKETING", price: "₹15,000", suffix: "/ month", bullets: ["WhatsApp Campaigns", "Email Campaigns", "Customer Segmentation", "Automated Follow-Ups", "Retention Flows"], outcome: "Increase Repeat Customers And Retention", cta: "Improve Retention" }
    ];
    document.querySelectorAll("#services .solution-package").forEach((card, index) => {
      const data = packages[index];
      if (!data) return;
      updateCard(card, data);
    });

    updateText("#automation .section-heading h2", "AI automation for lead handling, follow-up and business operations");
    updateText("#automation .section-heading p:not(.eyebrow)", "Connect Google Ads, website enquiries, WhatsApp, email, task routing and reporting so your business responds faster with less manual work.");
    updateList([...document.querySelectorAll("#automation .signal-column:first-child .signal-node span")], ["Google Ads Leads", "Shopify Enquiries", "Website Forms", "WhatsApp Messages", "Email Replies", "Customer Requests"]);
    updateList([...document.querySelectorAll("#automation .signal-column:last-child .signal-node span")], ["Lead Routing", "WhatsApp Follow-Up", "Email Sequences", "Task Creation", "Reporting Dashboards", "Customer Retention"]);
    updateAutomationModules();
    updateList([...document.querySelectorAll("#automation .automation-feed-row span:first-child")], ["Lead received from Google Ads", "WhatsApp follow-up triggered", "Email nurture sequence started", "Task assigned automatically", "Weekly performance report generated"]);
  ...
  function updateCard(card, data) {
    ...
    const suffix = card.querySelector(".package-price span");
    const bullets = card.querySelectorAll(".package-includes li");
    const outcome = card.querySelector(".result-badge span");
    const cta = card.querySelector(".package-cta");
    if (icon) icon.textContent = data.icon;
    if (tag) tag.textContent = data.tag;
    if (title) title.textContent = data.title;
    if (price) price.textContent = data.price;
    if (suffix) suffix.textContent = data.suffix;
    updateList([...bullets], data.bullets);
    if (outcome) outcome.textContent = data.outcome;
    if (cta) cta.textContent = data.cta;
  }

  function updateAutomationModules() {
    const modules = [
      ["Lead Automation", ["Google Ads Lead", "Lead Routing", "Sales Follow-Up"]],
      ["WhatsApp Follow-Up", ["New Enquiry", "Message Trigger", "Faster Response"]],
      ["Email Automation", ["Customer Segment", "Nurture Sequence", "Repeat Engagement"]],
      ["Task Automation", ["Business Request", "Workflow Rule", "Assigned Action"]],
      ["AI Workflow Support", ["Manual Process", "AI Logic", "Faster Execution"]],
      ["Reporting Automation", ["Campaign Data", "Auto Report", "Weekly Decisions"]]
    ];
    document.querySelectorAll("#automation .automation-module").forEach((module, index) => {
      const data = modules[index];
      if (!data) return;
      const heading = module.querySelector("h4");
      const values = module.querySelectorAll(".module-flow span");
      if (heading) heading.textContent = data[0];
      updateList([...values], data[1]);
    });
  }

  function updateContactCopy() {
    updateText("#contact .contact-copy .eyebrow", "PROJECT ENQUIRY FLOW");
    updateText("#contact .contact-copy h2", "Need leads, a Shopify website, automation or retention marketing?");
    updateText("#contact .contact-copy p", "Share your goal so I can suggest the right path across Google Ads, Shopify development, AI automation, WhatsApp marketing or email marketing.");
    updateText("#contact .form-head h3", "Request A Growth Project Discussion");
    updateText("#contact .form-head p", "Share the essentials so I can understand your traffic, website, automation or retention requirement before replying.");
    const serviceSelect = form?.elements.service;
    if (serviceSelect) {
      serviceSelect.innerHTML = `<option value="">Select one</option><option>Google Ads Management</option><option>Google Ads + Shopify Growth Package</option><option>Shopify Website Development</option><option>AI Automation Setup</option><option>WhatsApp & Email Marketing</option><option>Conversion Tracking / Reporting</option>`;
    }
  }

  function updateFooterCopy() {
    const footerLead = document.querySelector(".footer-brand + p");
    if (footerLead) footerLead.textContent = "Google Ads, Shopify websites, AI automation, WhatsApp marketing and email retention systems.";
    updateText(".footer-cta h3", "Build your growth system");
    updateText(".footer-cta p", "Start with a focused project discussion.");
  }

  function replaceEngineTerminal() {
    const original = document.getElementById("engine-log");
    if (!original || original.dataset.copyUpdated === "true") return;
    const clone = original.cloneNode(false);
    clone.id = "engine-log";
    clone.dataset.copyUpdated = "true";
    original.replaceWith(clone);
    const lines = [
      "google ads: moving budget toward high-intent search terms",
      "shopify: improving product page speed and conversion flow",
      "whatsapp: triggering instant follow-up for new enquiries",
      "email: starting retention sequence for repeat customers",
      "ai automation: routing leads and tasks without manual handoff"
    ];
    if (reduceMotion) { clone.textContent = "> " + lines[0]; return; }
    let lineIndex = 0;
    let charIndex = 0;
    let deleting = false;
    ...
    function tick() {
      ...
      if (!deleting) {
        charIndex++;
        clone.innerHTML = full.slice(0, charIndex) + cursor;
        if (charIndex >= full.length) { deleting = true; setTimeout(tick, 1700); return; }
        setTimeout(tick, 28);
        return;
      }
      charIndex--;
      clone.innerHTML = full.slice(0, charIndex) + cursor;
      if (charIndex <= 0) { deleting = false; lineIndex = (lineIndex + 1) % lines.length; setTimeout(tick, 300); return; }
      setTimeout(tick, 12);
    }
    tick();
  }

  function updateNavbar() { header?.classList.toggle("scrolled", window.scrollY > 20); }
  ...
  window.addEventListener("load", () => setTimeout(updateBelowHeroCopy, 80));
  ...
  document.querySelectorAll("[data-event]").forEach((element) => {
    element.addEventListener("click", () => {
      trackEvent(element.dataset.event, { label: element.textContent.trim(), destination: element.getAttribute("href") || "" });
    });
  });
