(() => {
    ...
    styles.textContent = `
      .how-work-section{
        ...
        background:
          ...
          radial-gradient(circle at 82% 14%,rgba(6,182,212,.08),transparent 30%),
      ...
      .how-work-section .container{position:relative;z-index:1}
      .how-work-head{
        display:grid;
      ...
      .how-work-head .eyebrow{margin-top:0;color:#2563eb}
      .how-work-head h2{
        margin:0;
        max-width:720px;
      ...
      .process-timeline:before{background:#dbe3ef}
      .process-line-fill{
        width:0;
        right:auto;
      ...
      .how-work-section.is-visible .process-line-fill{width:84%}
      .process-step{
        position:relative;
        min-width:0;
        display:flex;
      ...
      .process-step.final .step-marker{
        color:#fff;
        background:linear-gradient(135deg,#2563eb,#06b6d4);
        border-color:rgba(6,182,212,.45);
      }
      .process-step.final .process-step-card{
        border-color:#bae6fd;
        box-shadow:0 30px 76px rgba(37,99,235,.16);
      }
      .how-work-section.is-visible .process-step .step-marker{
        border-color:#93c5fd;
        box-shadow:0 20px 54px rgba(37,99,235,.14);
      }
      .how-work-section.is-visible .process-step .step-marker:after{opacity:1}
      .how-work-section.is-visible .process-step:nth-child(2) .step-marker{transition-delay:.22s}
      .how-work-section.is-visible .process-step:nth-child(3) .step-marker{transition-delay:.44s}
      .how-work-section.is-visible .process-step:nth-child(4) .step-marker{transition-delay:.66s}
      .how-work-section.is-visible .process-step.final .step-marker{
        animation:finalStepPulse 2.8s ease-in-out infinite;
      }
      @keyframes finalStepPulse{
        0%,100%{box-shadow:0 22px 56px rgba(37,99,235,.22),0 0 0 0 rgba(6,182,212,.2)}
        50%{box-shadow:0 26px 68px rgba(37,99,235,.28),0 0 0 12px rgba(6,182,212,0)}
      }
      .how-work-section .reveal-work{
        opacity:0;
        transform:translateY(18px);
        transition:opacity .75s ease,transform .75s ease;
      }
      .how-work-section.is-visible .reveal-work{opacity:1;transform:translateY(0)}
      .how-work-section.is-visible .process-step:nth-child(1){transition-delay:.08s}
      .how-work-section.is-visible .process-step:nth-child(2){transition-delay:.22s}
      .how-work-section.is-visible .process-step:nth-child(3){transition-delay:.36s}
      .how-work-section.is-visible .process-step:nth-child(4){transition-delay:.5s}
      @media(max-width:980px){
        .how-work-head{grid-template-columns:1fr;gap:18px;margin-bottom:42px}
        .process-timeline{grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}
        .process-timeline:before,.process-line-fill{display:none}
        .process-step-card{min-height:210px}
      }
      @media(max-width:620px){
        .how-work-head{text-align:left}
        .process-timeline{grid-template-columns:1fr;gap:18px;padding-left:28px}
        .process-timeline:before{
          display:block;
          left:18px;
          right:auto;
        ...
        .process-line-fill{
          ...
          height:0;
          right:auto;
          transition:height 1.35s cubic-bezier(.2,.8,.2,1);
        }
        .how-work-section.is-visible .process-line-fill{height:calc(100% - 20px)}
        .process-step{display:grid;grid-template-columns:72px minmax(0,1fr);gap:0 16px;padding-top:0}
        .step-marker{width:72px;height:72px;font-size:1.05rem}
        .process-step-card{min-height:auto;padding:20px;border-radius:18px}
      }
      @media(prefers-reduced-motion:reduce){
        .how-work-section .reveal-work,.process-step,.step-marker,.process-line-fill{transition:none!important;animation:none!important;opacity:1!important;transform:none!important}
        .process-line-fill{width:84%!important}
      }
    `;
        ...
        <div class="container">
          <div class="how-work-head reveal-work">
            <div>
              ...
              <h2>From Brief to Measurable Growth</h2>
            </div>
          ...
          <div class="process-timeline" aria-label="Client delivery process timeline">
            ...
            <article class="process-step reveal-work">
              <div class="step-marker" aria-hidden="true">01</div>
              <div class="process-step-card">
                <div class="process-kicker"><span>Step 01</span><span class="timeline-badge">Week 1</span></div>
                <h3>Discovery &amp; Audit</h3>
                <p>Map your current marketing, website, tracking and automation gaps.</p>
              </div>
            </article>
            <article class="process-step reveal-work">
              <div class="step-marker" aria-hidden="true">02</div>
              <div class="process-step-card">
                <div class="process-kicker"><span>Step 02</span><span class="timeline-badge">Week 1-2</span></div>
                <h3>Custom Strategy</h3>
                <p>Build a clear growth plan with channels, priorities, timelines and success metrics.</p>
              </div>
            </article>
            <article class="process-step reveal-work">
              <div class="step-marker" aria-hidden="true">03</div>
              <div class="process-step-card">
                <div class="process-kicker"><span>Step 03</span><span class="timeline-badge">Week 2-4</span></div>
                <h3>Launch &amp; Execute</h3>
                <p>Campaigns, websites and workflows go live with proper tracking from day one.</p>
              </div>
            </article>
            <article class="process-step final reveal-work">
              <div class="step-marker" aria-hidden="true">04</div>
              <div class="process-step-card">
                <div class="process-kicker"><span>Step 04</span><span class="timeline-badge">Ongoing</span></div>
                <h3>Optimise &amp; Scale</h3>
                <p>Review performance, improve conversion paths and scale what actually works.</p>
              </div>
            </article>
          </div>
        </div>
  ...
  function transformServicePackagesSection() {
    ...
    section.innerHTML = `
      <div class="container">
        <div class="service-packages-head reveal-package"><div><p class="eyebrow">SERVICES &amp; ENGAGEMENT</p><h2>Growth Systems Built Around Your Business Goals</h2></div><p>Choose the service that solves your biggest growth bottleneck.</p></div>
        <div class="package-grid" aria-label="Service packages">
          <article class="solution-package reveal-package"><div class="package-top"><div class="package-icon" aria-hidden="true">M</div><span class="package-tag">Customer Acquisition</span><h3>META ADS MANAGEMENT</h3><div class="package-price"><strong>₹10,000</strong><span>/ month</span></div></div><ul class="package-includes"><li>Campaign Setup</li><li>Audience Research</li><li>Creative Direction</li><li>Weekly Optimization</li><li>Performance Reporting</li></ul><div class="result-badge"><i></i><span>Generate More Qualified Leads</span></div><a class="package-cta" href="#contact" data-event="book_call_click">Start Growing</a></article>
          <article class="solution-package is-featured reveal-package"><span class="popular-ribbon">MOST POPULAR</span><div class="package-top"><div class="package-icon" aria-hidden="true">G</div><span class="package-tag">Multi-Channel Growth</span><h3>META + GOOGLE ADS</h3><div class="package-price"><strong>₹15,000</strong><span>/ month</span></div></div><ul class="package-includes"><li>Meta Ads</li><li>Google Ads</li><li>Conversion Tracking</li><li>Budget Optimization</li><li>Weekly Reporting + Growth Insights</li></ul><div class="result-badge"><i></i><span>Scale Across Multiple Channels</span></div><a class="package-cta" href="#contact" data-event="book_call_click">Scale My Growth</a></article>
          <article class="solution-package reveal-package"><div class="package-top"><div class="package-icon" aria-hidden="true">A</div><span class="package-tag">Operational Efficiency</span><h3>AI AUTOMATION SETUP</h3><div class="package-price"><strong>₹5,000</strong><span>/ setup</span></div></div><ul class="package-includes"><li>Lead Routing</li><li>CRM Automation</li><li>WhatsApp Automation</li><li>Workflow Setup</li><li>Process Optimization</li></ul><div class="result-badge"><i></i><span>Reduce Manual Work</span></div><a class="package-cta" href="#contact" data-event="book_call_click">Automate My Business</a></article>
          <article class="solution-package reveal-package"><div class="package-top"><div class="package-icon" aria-hidden="true">W</div><span class="package-tag">Conversion Foundation</span><h3>WEBSITE DEVELOPMENT</h3><div class="package-price"><strong>₹10,000</strong><span>/ project</span></div></div><ul class="package-includes"><li>Responsive Design</li><li>Landing Pages</li><li>WordPress / Shopify</li><li>Speed Optimization</li><li>Basic SEO Setup</li></ul><div class="result-badge"><i></i><span>Turn Visitors Into Customers</span></div><a class="package-cta" href="#contact" data-event="book_call_click">Build My Website</a></article>
        </div>
      </div>
    `;
  }
